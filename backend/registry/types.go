...
type EquipmentDefinition struct {
	...
	ConfigurationFields []ConfigField       `json:"configurationFields,omitempty"`
	LimitsFields        []ConfigField       `json:"limitsFields,omitempty"`
	DefaultValuesFields []ConfigField       `json:"defaultValuesFields,omitempty"`
	ReductionFields     []ConfigField       `json:"reductionFields,omitempty"`
	HomingFields        []ConfigField       `json:"homingFields,omitempty"`
	AutoTuneFields      []ConfigField       `json:"autoTuneFields,omitempty"`
	InverterFields      []ConfigField       `json:"inverterFields,omitempty"`
