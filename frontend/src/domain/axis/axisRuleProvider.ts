// src/domain/axis/axisRuleProvider.ts
...
export class AxisRuleProvider {
  ...
  public static getAvailableMotors(controllerType: string, driveReference: string): string[] {
  ...
  public static getAvailableMotionTypes(controllerType: string): string[] {
    ...
    return ["PERIODIC_ROTARY", "ROTARY", "LIMITED_ROTARY", "PERIODIC_LINEAR", "LINEAR", "LIMITED_LINEAR"];
  }
  ...
  public static getAvailableHomingTypes(controllerType: string, driveReference: string): string[] {
    // This prevents the AxisSanitizer from auto-selecting a value on initialization
  ...
  public static isLimitFieldVisible(fieldKey: string, axis: any): boolean {
    ...
    switch (fieldKey) {
      ...
      case "maxTorque":
        return axis.controllerType === "ACOPOS" || axis.controllerType === "PSE";
      case "stopTorque":
      case "followingError":
        return axis.controllerType === "ACOPOS";
      case "period":
  ...
  public static isHomingFieldVisible(fieldKey: string, axis: any): boolean {
    ...
    switch (fieldKey) {
      ...
      case "acceleration":
      case "backoff":
        return homing === "ABSOLUTE_SWITCH" || homing === "BLOCK_TORQUE" || homing === "BLOCK_LAG_ERROR";
      case "torqueLimit":
